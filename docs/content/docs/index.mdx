...
description: The all-in-one backend framework — Bun, MongoDB, multi-tenant, workflows, and more.
icon: BookOpen
full: true
---
...
<div className="mb-16">
  ...
  <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div className="rounded-xl border bg-fd-card p-6 hover:bg-fd-accent/50 transition-colors duration-200">
      ...
      <h3 className="font-semibold text-sm mb-1">MCP Tools</h3>
      <p className="text-xs text-fd-muted-foreground">Expose tenant tools to LLM agents (Claude, Cursor, VS Code) via the Model Context Protocol.</p>
    </div>
    <div className="rounded-xl border bg-fd-card p-6 hover:bg-fd-accent/50 transition-colors duration-200">
      <div className="mb-3 text-fd-primary">
