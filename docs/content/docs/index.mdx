...
<div className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-fd-background via-fd-primary/5 to-fd-background p-12 md:p-20 mb-16">
  ...
  <div className="relative mx-auto max-w-3xl text-center">
    ...
    <p className="mx-auto max-w-2xl text-lg text-fd-muted-foreground mb-10 leading-relaxed">
      A single cohesive stack — <Bun size={18} className="inline align-text-bottom mx-0.5" /> <strong>Bun</strong> runtime,{" "}
...
<div className="mb-16 rounded-2xl border bg-fd-card/50 p-8 md:p-12">
  <div className="flex flex-col lg:flex-row items-start gap-10">
    ...
    <div className="flex-1 w-full rounded-xl border bg-fd-background p-6 overflow-hidden">
      ...
      <pre className="text-sm font-mono text-fd-foreground leading-relaxed overflow-x-auto">
...
export default define.Collection({
  ...
  fields: [
    ...
    { name: "role",  type: "enum", enumOptions: { items: ["admin", "editor", "viewer"] } },
  ],
  api: { access: { "*": "authenticated" } },
  hooks: { beforeOperation: [sendWelcomeEmail] },
});`}
      </pre>
    </div>
  </div>
...
<div className="mb-16">
  ...
  <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div className="rounded-xl border bg-fd-card p-6 hover:bg-fd-accent/50 transition-colors duration-200">
      ...
      <p className="text-xs text-fd-muted-foreground">Lifecycle hooks, custom actions, services, before/after operation.</p>
    </div>
    <div className="rounded-xl border bg-fd-card p-6 hover:bg-fd-accent/50 transition-colors duration-200">
      <div className="mb-3 text-fd-primary">
