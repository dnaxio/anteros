...
```json
{
  ...
  "_file": {
    ...
    "mimetype": "image/jpeg",
    "size": 2048576,
    "url": "/files/v1/photos/550e8400-....jpg"
  },
  "description": "Photo de profil",
  "alt": "Mon avatar"
}
...
```typescript
const url = api.getFileUrl('photos', 'abc.jpg')
// /files/v1/photos/abc.jpg

const thumb = api.getFileUrl('photos', 'abc.jpg', {
  width: 200,
  format: 'webp',
  quality: 80
})
// /files/v1/photos/abc.jpg?w=200&format=webp&q=80
```
