...
| [Reference](/docs/reference/configuration)              | Configuration, tenants, collections, fields, hooks, authentication, access control, custom actions, files, services, WebSockets, middlewares, workflows, routes, scripts, lifecycle, MCP, caches, audit, utils, errors, crypto, replication, variables |
